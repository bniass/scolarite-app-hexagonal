package com.ecole221.kafka.service.consumer.config;

import com.ecole221.kafka.service.config.KafkaConfigData;
import com.ecole221.kafka.service.config.KafkaConsumerConfigData;
...
@Configuration
@ConditionalOnProperty(prefix = "kafka-consumer", name = "key-deserializer")
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put("specific.avro.reader", kafkaConsumerConfigData.getSpecificAvroReader());
        return props;
    }
